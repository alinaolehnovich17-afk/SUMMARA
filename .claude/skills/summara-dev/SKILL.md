...
- Локальные рабочие заметки (журнал идей/бэклог, аудит, контекст) — если ведутся на машине
  пользователя (они в `.gitignore`, в публичный репозиторий не входят). Прочитай их, если есть.
