...
Документы: `README.md` (обзор проекта), `GUIDE.md` (руководство пользователя).
Личные рабочие заметки (журнал/аудит/контекст) ведутся локально и в репозиторий не входят (`.gitignore`).
